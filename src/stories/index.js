...
storiesOf("Icons", module).add("DownwardChevron", () => (
  <div>
    ...
    <h4>props</h4>
    <p>
      The props it accepts are: &lt;DownwardChevron verticalPadding="2em"
      horizontalPadding="3em" colour="#000" width="10em" /&gt;
    </p>
    <DownwardChevron
      verticalPadding="2em"
...
storiesOf("Icons", module).add("UpwardChevron", () => (
  <div>
    ...
    <h4>props</h4>
    <p>
      The props it accepts are: &lt;UpwardChevron verticalPadding="2em"
      horizontalPadding="3em" colour="#000" width="10em" /&gt;
    </p>
    <UpwardChevron
      verticalPadding="2em"
...
storiesOf("Buttons", module).add("Button", () => (
  <div>
    ...
    <h3>Defaults</h3>
    <p>
      With no props it defaults to what is called a "default button"in the Web
      Experience Toolkit:
    </p>
    ...
    <p>
      ...
      event handler: &lt;Button primary onClick=&#123;action("clicked")&#125;
